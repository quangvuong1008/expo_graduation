...
import { onDeleteWalletRequest, onDeleteWalletResponse, onUpdateWalletRequest } from "../../store/actions/commonActions";
...
const MyWalletsEdit = memo(({ route }: any) => {
  ...
  const onPressYes = async () => {
    dispatch(
      onDeleteWalletRequest(walletId)
    );
    setShowDialog(false);
    navigation.goBack();
  };
      ...
      <ScrollView scrollEnabled={false}>
        ...
        <View style={styles.contentView}>
          ...
          <AnimatedInput
            ...
            imageIcon={typeWallet?.icon ? IMAGE_ICON[`${typeWallet.icon}`] : null}
