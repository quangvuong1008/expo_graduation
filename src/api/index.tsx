...
// PRODUCTION
//export const SERVER_ADDRESS = 'https://api.monsy.timistudio.dev';

// DEVELOPMENT
//export const SERVER_ADDRESS = 'http://192.168.55.109:3000';
...
export const apiGetTransactionByMonth = ({year = '2020', month = '01', page = 0, limit = 100}) => {
  return request(`transaction/list/${year}/${month}/${page}/${limit}`, 'GET', null, null);
};

export const apiGetTransactionWalletByMonth = ({walletId = 1, year = '2020', month = '01', page = 0, limit = 100}) => {
  return request(`wallet/get/${walletId}/transactions/${year}/${month}/${page}/${limit}`, 'GET', null, null);
};
...
*/
export const apiChartGetTransactionAllWallet = ({year = '2020', month = '01'}) => {
...
*Chart get transaction all wallet
*/
export const apiChartGetTransactionByWallet = ({walletId = 1,year = '2020', month = '01'}) => {
  return request(`wallet/chart/${walletId}/transaction/${year}/${month}`, 'GET', null, null);
};
...
export const apiDetailChartGetAllWallet = ({year = '2020', month = '01'}) => {
  return request(`transaction/detail_chart/${year}/${month}`, 'GET', null, null);
};

/*
*Chart get for one wallet
*/
export const apiDetailChartGetOneWallet = ({walletId = -1, year = '2020', month = '01'}) => {
  if (walletId == -1) {
    return request(`transaction/detail_chart/${year}/${month}`, 'GET', null, null);
  }
  return request(`transaction/detail_chart/${walletId}/${year}/${month}`, 'GET', null, null);
};
